...
const navItems: NavItem[] = [
  ...
  { id: "stats", label: "Estadisticas", icon: (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>) },
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-4" style={{ borderBottom: '1px solid rgba(19,122,140,0.12)' }}>
        ...
        <div className="flex-1 min-w-0">
          ...
          {plan === 'premium' && <span className="ml-1 text-yellow-400 text-[10px]">star</span>}
        </div>
      </div>

      {/* Nav */}
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        <p className="text-[10px] font-semibold uppercase tracking-widest px-3 mb-3" style={{ color: 'rgba(19,122,140,0.5)' }}>
          Principal
        </p>
      ...
      {/* Footer */}
      <div className="px-4 py-4 space-y-2" style={{ borderTop: '1px solid rgba(19,122,140,0.12)' }}>
        {isAdmin && viewingAs && (
